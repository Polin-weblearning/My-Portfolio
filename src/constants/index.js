...
export const PROJECTS = [
  ...
  {
    title: "KILO HEALT WEBSITE",
    image: project2,
    description:
      "Developed a health website with features for contacting doctors and checking health status, focusing on user-friendly design and functionality.",
    technologies: ["HTML", "CSS", "ReactJS", "Tailwind CSS", "Figma"],
  },
  {
